...
// 主站状态: OP  从站数量: 由 config.deni 决定 (本案例用作 CNC 多轴插补, 至少 2~3 轴 X/Y/Z)
//
// 本程序加载 config.deni 把全部松下 A6B 从站恢复到 OP 状态, 逐轴最小 PDO 循环示例。
...
namespace EtherCATRestore
{
    ...
    // 字段顺序必须与 PDO 条目顺序逐字节一致, 来源 ESI: panasonic_minas-a6bf_v1_9_1_0_117_0.xml
    ...
    public struct PA_Input
    {
        ...
        public int TouchProbe1PosValue;          // Touch Probe Pos1 Pos Value 0x60BA:0  DINT
